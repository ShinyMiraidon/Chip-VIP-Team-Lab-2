...
VL_INLINE_OPT void VExercise3___024root___nba_sequent__TOP__0(VExercise3___024root* vlSelf) {
    ...
    if (vlSelf->nReset) {
        ...
        if ((0U == (IData)(vlSelf->Exercise3__DOT__m3__DOT__count))) {
            ...
            __Vdly__out = ((0xff00U & ((IData)(vlSelf->out) 
                                       << 8U)) | (0xffU 
                                                  & ((IData)(vlSelf->out) 
                                                     >> 8U)));
        } else if ((1U == (IData)(vlSelf->Exercise3__DOT__m3__DOT__count))) {
            __Vdly__out = ((0xff00U & ((IData)(vlSelf->out) 
                                       << 8U)) | (IData)(vlSelf->Exercise3__DOT__wire1));
        } else if ((2U == (IData)(vlSelf->Exercise3__DOT__m3__DOT__count))) {
            __Vdly__out = (((IData)(vlSelf->Exercise3__DOT__wire2) 
                            << 8U) | (0xffU & ((IData)(vlSelf->out) 
                                               >> 8U)));
        } else if ((3U == (IData)(vlSelf->Exercise3__DOT__m3__DOT__count))) {
        ...
        vlSelf->Exercise3__DOT__m3__DOT__count = (3U 
                                                  & ((IData)(1U) 
                                                     + (IData)(vlSelf->Exercise3__DOT__m3__DOT__count)));
    } else {
        __Vdly__out = (((IData)(vlSelf->Exercise3__DOT__wire1) 
                        << 8U) | (IData)(vlSelf->Exercise3__DOT__wire2));
        vlSelf->Exercise3__DOT__m3__DOT__count = 0U;
    }
