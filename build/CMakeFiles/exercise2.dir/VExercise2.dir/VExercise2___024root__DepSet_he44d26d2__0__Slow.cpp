...
VL_ATTR_COLD void VExercise2___024root___eval_initial(VExercise2___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__nReset = vlSelf->nReset;
}
...
#endif
                VL_FATAL_MT("/Users/michaellippe/Local", 9, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void VExercise2___024root___dump_triggers__act(VExercise2___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge clk or negedge nReset)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VExercise2___024root___dump_triggers__nba(VExercise2___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge clk or negedge nReset)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VExercise2___024root___ctor_var_reset(VExercise2___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__nReset = VL_RAND_RESET_I(1);
}
